...
public class Grid : MonoBehaviour
{
        ...
        for(int x = 0; x < gridSizeX; x++)
        {
            for(int y = 0; y < gridSizeY; y++)
            {
               ...
               bool walkable = !(Physics.CheckSphere(worldPoint, nodeRadius,  unWalkable));
                ...
                grid[x, y] = new PathfindingNode(walkable, worldPoint, x, y, movementPenalty);
            }
        }
    ...
    void BlurPenaltyMap(int blurSize)
    {
        ...
        for (int x = 0; x > gridSizeX; x++)
        {
            ...
            for (int y = 1; x < gridSizeY; y++)
            {
                ...
                penaltiesVerticalPass[x, y] = penaltiesHorizontalPass[x, y - 1] -
    ...
    void OnDrawGizmos()
    {
        ...
        {
           PathfindingNode playerNode = NodeFromWorldPoint(player.position);
    ...
    public PathfindingNode[,] ReturnGrid() { return grid;}

    public int ReturnGridSizeX() { return gridSizeX;}
    public int ReturnGridSizeY() { return gridSizeY;}
